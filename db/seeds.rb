...
User.create!(name:  "Daniel3",
             email: "daniel_kcy6@gmail.com",
             password:              "123456",
             password_confirmation: "123456",
             authority_level: 1)

User.create!(name:  "Jolie3",
             email: "jolie_kcy6@gmail.com",
             password:              "123456",
             password_confirmation: "123456",
             currentCourse: 1)

User.create!(name:  "Admin2",
             email: "admin_kcy6@gmail.com",
             password:              "foobar",
             password_confirmation: "foobar",
             admin: true,
             currentCourse: 2)
